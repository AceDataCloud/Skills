...
| [veo-video](skills/veo-video/) | Generate videos with Google Veo (native audio, extend, reshoot, object editing) |
...
| Skill | Description |
|-------|-------------|
| [ai-chat](skills/ai-chat/) | Unified LLM gateway — GPT, Claude, Gemini, DeepSeek, Grok, GLM (50+ models) |
...
| [webextrator](skills/webextrator/) | Extract structured content and render JavaScript web pages |
