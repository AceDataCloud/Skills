...
> **Async:** See [async task polling](../_shared/async-tasks.md). Poll via `POST /seedance/tasks` with `{"id": "<task_id>"}`.
...
| `doubao-seedance-2-0-260128` | Text+Image-to-Video | Newer Seedance 2.0 quality tier |
