...
| `duration` | `-1` – `15` | Duration in seconds (`-1` is accepted by the API; behavior is service-defined) |
...
- Duration range is **-1–15 seconds** (`-1` is accepted by the API and is handled service-side)
