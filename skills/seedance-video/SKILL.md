...
| `duration` | integer `-1` – `15` | Duration in seconds. Current OpenAPI permits `-1`, but its behavior is unspecified; use explicit positive durations for predictable behavior. |
