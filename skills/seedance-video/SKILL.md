...
> **Async:** See [async task polling](../_shared/async-tasks.md). Poll via `POST /seedance/tasks` with `{"id":"...","action":"retrieve"}`.
...
| `doubao-seedance-2-0-260128` | Text+Image-to-Video | Newer v2 quality model |
| `doubao-seedance-2-0-fast-260128` | Text+Image-to-Video | Faster v2 generation |
