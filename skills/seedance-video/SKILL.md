...
| `duration` | integer `-1` – `15` | Duration in seconds. Current OpenAPI schema permits `-1` to `15`; for predictable behavior, use positive durations (typically `2`–`15`, and often `4`–`15` for Seedance 2.0 models). |
