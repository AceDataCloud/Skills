...
| `duration` | integer | Duration in seconds. Use positive durations (typically `2`–`15`, and often `4`–`15` for Seedance 2.0 models). OpenAPI currently lists a minimum of `-1`, but `-1` behavior is undocumented and should be treated as unsupported. |
