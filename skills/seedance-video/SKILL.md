...
| `doubao-seedance-2-0-260128` | Text+Image-to-Video | Newer 2.0 flagship model |
| `doubao-seedance-2-0-fast-260128` | Text+Image-to-Video | Faster 2.0 generation |
...
- `POST /seedance/tasks` uses `id` / `ids`; use `action: "retrieve_batch"` for batch polling
