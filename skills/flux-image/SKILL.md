...
| `flux-2-klein` | Good | Fastest | 256–1440px | Ultra-fast compact generation |
...
- `flux-2-max` produces highest quality but is slowest — use dev/flex/klein for iteration and max for final output
