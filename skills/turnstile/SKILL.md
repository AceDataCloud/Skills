...
```json
{
  ...
  "started_at": 1753349653.0,
  "finished_at": 1753349665.0,
  "elapsed": 12.4
}
```
...
| `started_at` | Unix timestamp (seconds) when solving began |
| `finished_at` | Unix timestamp (seconds) when solving completed |
