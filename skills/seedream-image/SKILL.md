...
Edit an existing image by providing the source image URL(s) and a descriptive prompt. Seedream 5.0 Pro, Seedream 5.0, 4.5, and 4.0 all support image input.
...
- 5.0 Pro supports `1K`/`2K`; 5.0 supports `1K`/`2K`/`3K`/`4K`; 4.5 supports `2K`/`4K`; 4.0 supports `1K`/`2K`/`4K`
