---
name: veo-video
description: Generate AI videos with Google Veo via AceDataCloud API. Use when creating videos from text descriptions, animating still images into video, or blending multiple images into video. Supports Veo 3, Veo 3.1, and ingredient-fusion models.
license: Apache-2.0
metadata:
  author: acedatacloud
  version: "1.0"
...
| `veo31-fast-ingredients` | Yes (native) | Veo 3.1 fast, ingredient mode (requires images) |
...
- All current Veo models support **native audio** generation
