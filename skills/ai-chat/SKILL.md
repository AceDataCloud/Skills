...
| Model | Best For |
|-------|----------|
| `glm-5.2` | Latest GLM, highest capability |
| `glm-5.1` | High-quality GLM |
| `glm-5` | Stable, general-purpose |
| `glm-5-turbo` | Fast, efficient |
| `glm-4.7` | Reliable GLM 4.x |
| `glm-4.6` | GLM 4.x series |
| `glm-4.5` | Multimodal vision + text |
