...
> **Image-capable models vary by endpoint.** `/aichat2/conversations` accepts
> `gpt-4o-image` and `gpt-image-1`; use the dedicated Gemini or NanoBanana
> image endpoints for their image models — Gemini via
