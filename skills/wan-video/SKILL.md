...
| `ratio` | No | `"adaptive"`, `"16:9"`, `"4:3"`, `"1:1"`, `"3:4"`, `"9:16"` | Output aspect ratio, especially for `wan3.0-video` |
| `duration` | No | number | Video duration in seconds; Wan 2.6 commonly uses 5/10/15, Wan 3 supports 2–30 or `-1` automatic duration |
...
- Wan 2.6 durations are typically 5, 10, or 15 seconds; Wan 3 supports 2–30 seconds or `-1` automatic duration
