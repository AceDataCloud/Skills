...
| `4k` (Native 4K) | — | Highest | 4K output — only `kling-v3` and `kling-v3-omni`; not compatible with `camera_control` |
...
- `mode=4k` (Native 4K) is only supported by `kling-v3` and `kling-v3-omni`; it is incompatible with `camera_control`
