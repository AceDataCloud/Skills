...
| `mode` | `"std"`, `"pro"`, `"4k"` | Quality mode; defaults to `"std"` (`4k` only for `kling-v3` / `kling-v3-omni`, incompatible with `camera_control`) |
| `duration` | O1: `5`; v3/v3-omni: `3`–`15`; others: `5`, `10` | Duration in seconds; defaults to `5` |
