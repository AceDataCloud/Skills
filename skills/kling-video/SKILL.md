...
| `mode` | `"std"` (default), `"pro"`, `"4k"` | Quality mode (`4k` only for `kling-v3` / `kling-v3-omni`, incompatible with `camera_control`) |
| `duration` | `5` (default); O1: `5`; v3/v3-omni: `3`–`15`; others: `5`, `10` | Duration in seconds |
