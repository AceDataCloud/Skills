...
| `image_list` | array | Reference images; each item has `image_url` (string) and `type` (`"first_frame"`, `"end_frame"`) |
...
- `duration` accepts any number of seconds; `kling-v3` and `kling-v3-omni` support flexible `3`–`15` seconds
