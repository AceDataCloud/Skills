...
| `count` | integer 1–4, default 1 | Number of images to generate |
...
- `nano-banana-2-lite` is a lighter variant of the second-generation model; `nano-banana-2` offers full second-generation quality; `nano-banana-pro` offers the highest quality
