...
| `count` | integer [1–4] | Number of images to generate (default 1) |
...
- `nano-banana-2-lite` is a lightweight second-generation model between `nano-banana` and `nano-banana-2`; `nano-banana-pro` offers the highest quality
