...
- `nano-banana-2-lite` is a lightweight variant of the second-generation model; `nano-banana-2` is the full second-generation model; `nano-banana-pro` offers the highest quality
