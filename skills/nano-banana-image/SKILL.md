...
| `nano-banana-2-lite` | Lower-cost second-generation image generation |
...
- `nano-banana-2-lite` is the cheaper second-generation variant; `nano-banana-2` improves quality and `nano-banana-pro` offers the highest detail
- `:official` variants (e.g., `nano-banana:official`) route through the official channel
- `count` controls multi-image generation and currently accepts `1` to `4`
