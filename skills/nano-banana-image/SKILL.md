...
| `nano-banana-2-lite` | Lightweight second-generation model (fast) |
...
- `nano-banana-2` is the second-generation model; `nano-banana-2-lite` is a faster/lighter variant; `nano-banana-pro` offers the highest quality
