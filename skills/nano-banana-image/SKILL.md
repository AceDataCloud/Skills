...
- On OpenAI-compatible `/openai/images/*` endpoints, `n` is only effective for `dall-e-2`; for `nano-banana` models, values greater than 1 are ignored (send parallel requests instead)
