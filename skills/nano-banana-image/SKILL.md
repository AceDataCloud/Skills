...
| `nano-banana-2-lite` | Faster/lighter second-generation variant |
...
- `nano-banana-2-lite` is the lighter second-generation variant; `nano-banana-2` and `nano-banana-pro` prioritize quality
